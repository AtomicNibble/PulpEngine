...
void SessionVars::registerVars(void)
{
    ...
    ADD_CVAR_REF("net_connect_retry_delay", connectionRetryDelayMs_, connectionRetryDelayMs_, 1, (1000 * 60) * 10, core::VarFlag::SYSTEM | core::VarFlag::SAVE_IF_CHANGED,
    ...
    ADD_CVAR_REF("net_snap_max_buffered_ms", snapMaxbufferedMs_, snapMaxbufferedMs_, 1, 1000, core::VarFlag::SYSTEM | core::VarFlag::SAVE_IF_CHANGED,
        "Max amount of buffered snaps shots in ms");
