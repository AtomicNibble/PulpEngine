...
public:
    ...
    // Returns the memory requirement for an allocation of size, taking into account possible overhead.
    static constexpr inline size_t getMemoryRequirement(size_t size);

    // Returns the alignment requirement for an allocation requiring alignment, taking into account possible overhead.
