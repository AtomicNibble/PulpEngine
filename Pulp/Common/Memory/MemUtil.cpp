...
namespace Mem
{
    ...
    void SIMDMemCopy(void* __restrict _Dest, const void* __restrict _Source, size_t NumQuadwords)
    {
        ...
        switch (InitialQuadwordCount) {
            case 3:
                _mm_stream_si128(pDest + 2, _mm_load_si128(pSource + 2)); // Fall through
            case 2:
                _mm_stream_si128(pDest + 1, _mm_load_si128(pSource + 1)); // Fall through
            case 1:
                _mm_stream_si128(pDest + 0, _mm_load_si128(pSource + 0)); // Fall through
            default:
                break;
        }
        ...
        switch (CacheLines) {
            default:
            case 10:
                _mm_prefetch((char*)(pSource + 36), _MM_HINT_NTA); // Fall through
            case 9:
                _mm_prefetch((char*)(pSource + 32), _MM_HINT_NTA); // Fall through
            case 8:
                _mm_prefetch((char*)(pSource + 28), _MM_HINT_NTA); // Fall through
            case 7:
                _mm_prefetch((char*)(pSource + 24), _MM_HINT_NTA); // Fall through
            case 6:
                _mm_prefetch((char*)(pSource + 20), _MM_HINT_NTA); // Fall through
            case 5:
                _mm_prefetch((char*)(pSource + 16), _MM_HINT_NTA); // Fall through
            case 4:
                _mm_prefetch((char*)(pSource + 12), _MM_HINT_NTA); // Fall through
            case 3:
                _mm_prefetch((char*)(pSource + 8), _MM_HINT_NTA); // Fall through
            case 2:
                _mm_prefetch((char*)(pSource + 4), _MM_HINT_NTA); // Fall through
            case 1:
                _mm_prefetch((char*)(pSource + 0), _MM_HINT_NTA); // Fall through
    ...
    void SIMDMemFill(void* __restrict _Dest, __m128 FillVector, size_t NumQuadwords)
    {
        ...
        switch (NumQuadwords & 3) {
            case 3:
                _mm_stream_si128(pDest++, Source); // Fall through
            case 2:
                _mm_stream_si128(pDest++, Source); // Fall through
            case 1:
                _mm_stream_si128(pDest++, Source); // Fall through
