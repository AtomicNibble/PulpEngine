...
X_DECLARE_ENUM(ScriptMoudles)(CORE, SCRIPT, SOUND, IO);
X_DECLARE_ENUM(ScriptValueType)(TNIL, NONE, BOOLEAN, NUMBER, STRING, TABLE, VECTOR, FUNCTION, POINTER, HANDLE, USERDATA);
