...
#define X_ENABLE_ASSERTIONS_SOURCE_INFO 0
...
#define X_ENABLE_ASSET_LOADER_DEADLOCK_CHECK 1
#define X_ENABLE_SOUND_COMS 1
#define X_ENABLE_VIDEO_DEBUG 1
#elif X_RELEASE
#define X_LOG_BUFFER_SIZE 2048
...
#define X_ENABLE_UNHANDLED_EXCEPTION_HANDLER 1
#define X_ENABLE_ASSERTIONS 1
#define X_ENABLE_ASSERTIONS_SOURCE_INFO 1
#define X_ENABLE_LOGGING 1
#define X_ENABLE_LOGGING_SOURCE_INFO 0
#define X_ENABLE_FILE_STATS 1
#define X_ENABLE_FILE_ARTIFICAIL_DELAY 1
#define X_ENABLE_DIR_WATCHER 1
...
#define X_ENABLE_JOBSYS_PROFILER 1
#define X_ENABLE_RENDER_SHADER_RELOAD 1
#define X_ENABLE_ASSET_LOADER_DEADLOCK_CHECK 0
#define X_ENABLE_SOUND_COMS 1
#define X_ENABLE_VIDEO_DEBUG 1
#elif X_SUPER
#define X_LOG_BUFFER_SIZE 2048
...
#define X_ENABLE_MEMORY_ARENA_STATISTICS 1
#define X_ENABLE_MEMORY_DEBUG_POLICIES 1      // enables debug polices
#define X_ENABLE_MEMORY_DEBUG_POLICIES_DEFS 1 // enables the debug polic definitions, set to zero to ensure none are in use.
#define X_ENABLE_MEMORY_SIMPLE_TRACKING 1     // allow simple tracking even when debug polices disabled.
#define X_ENABLE_MEMORY_SOURCE_INFO 1
#define X_ENABLE_MEMORY_HUMAN_IDS 0
#define X_ENABLE_MINI_DUMP 1
#define X_ENABLE_SYMBOL_RESOLUTION 1
