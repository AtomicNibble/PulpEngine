...
inline bool LoggerNoFilterPolicy::Filter(LogType::Enum type, X_SOURCE_INFO_LOG_CA(const SourceInfo&) const char* channel, int verbosity, const char* format, va_list args)
{
