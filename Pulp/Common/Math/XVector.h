...
public:
    ...
    X_INLINE const Vec2<T> operator+(const Vec2<T>& rhs) const
    {
    ...
    X_INLINE Vec2<T>& operator+=(const Vec2<T>& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        return *this;
    ...
    X_INLINE const Vec2<T> operator/(T rhs) const
    {
        return Vec2<T>(x / rhs, y / rhs);
    }
    X_INLINE Vec2<T>& operator+=(T rhs)
    {
        x += rhs;
        y += rhs;
        return *this;
    ...
    X_INLINE Vec2<T> operator-() const
    {
        return Vec2<T>(-x, -y);
    }
    ...
    {
        return math<T>::abs(x - oth.x) <= epsilon && math<T>::abs(y - oth.y) <= epsilon;
    }
    ...
    static Vec2<T> NaN()
    {
        return Vec2<T>(math<T>::NaN(), math<T>::NaN());
    }
...
public:
    ...
    explicit Vec3(const Vec2<T>& src) :
        x(src.x),
        y(src.y),
        z(0)
    {
    ...
    X_INLINE Vec3<T> operator*(const float rhs) const
    {
        return Vec3<T>(x * rhs, y * rhs, z * rhs);
    }
    X_INLINE T operator*(const Vec3<T>& rhs) const
    {
        return x * rhs.x + y * rhs.y + z * rhs.z;
    }

    X_INLINE Vec3<T>& operator+=(const Vec3<T>& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        z += rhs.z;
    ...
    X_INLINE const Vec3<T> operator/(T rhs) const
    {
        return Vec3<T>(x / rhs, y / rhs, z / rhs);
    }
    X_INLINE Vec3<T>& operator+=(T rhs)
    {
        x += rhs;
        y += rhs;
        z += rhs;
    ...
    X_INLINE Vec3<T> operator-() const
    {
        return Vec3<T>(-x, -y, -z);
    }
    ...
    {
        return math<T>::abs(x - oth.x) <= epsilon && math<T>::abs(y - oth.y) <= epsilon && math<T>::abs(z - oth.z) <= epsilon;
    }
    ...
    static Vec3<T> NaN()
    {
        return Vec3<T>(math<T>::NaN(), math<T>::NaN(), math<T>::NaN());
    }
...
public:
    ...
    X_INLINE Vec4<T>& operator+=(const Vec4<T>& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        z += rhs.z;
    ...
    X_INLINE const Vec4<T> operator/(T rhs) const
    {
        return Vec4<T>(x / rhs, y / rhs, z / rhs, w / rhs);
    }
    X_INLINE Vec4<T>& operator+=(T rhs)
    {
        x += rhs;
        y += rhs;
        z += rhs;
    ...
    X_INLINE Vec4<T> operator-() const
    {
    ...
    static Vec4<T> NaN()
    {
        return Vec4<T>(math<T>::NaN(), math<T>::NaN(), math<T>::NaN(), math<T>::NaN());
    }
...
public:
    ...
    explicit Vec5(const Vec3<T>& src) :
        x(src.x),
        y(src.y),
        z(src.z),
        s(0),
    ...
    X_INLINE const Vec5<T> operator+(const Vec5<T>& rhs) const
    {
        return Vec5<T>(x + rhs.x, y + rhs.y, z + rhs.z, s + rhs.s, t + rhs.t);
    }
    X_INLINE const Vec5<T> operator-(const Vec5<T>& rhs) const
    {
        return Vec5<T>(x - rhs.x, y - rhs.y, z - rhs.z, s - rhs.s, t - rhs.t);
    ...
    X_INLINE Vec5<T>& operator+=(const Vec5<T>& rhs)
    {
        x += rhs.x;
        y += rhs.y;
        z += rhs.z;
    ...
    X_INLINE const Vec5<T> operator/(T rhs) const
    {
        return Vec5<T>(x / rhs, y / rhs, z / rhs.z, s / rhs.s, t / rhs.t);
    }
    X_INLINE Vec5<T>& operator+=(T rhs)
    {
        x += rhs;
        y += rhs;
        z += rhs;
    ...
    X_INLINE Vec5<T> operator-() const
    {
        return Vec5<T>(-x, -y, -z, -s, -t);
    }
...
inline Vec2<T> operator*(Y s, const Vec2<T>& v)
{
    return Vec2<T>(v.x * s, v.y * s);
}
template<typename T, typename Y>
inline Vec2<T> operator*(const Vec2<T>& v, Y s)
{
    return Vec2<T>(v.x * s, v.y * s);
}
template<typename T, typename Y>
inline Vec3<T> operator*(Y s, const Vec3<T>& v)
{
    return Vec3<T>(v.x * s, v.y * s, v.z * s);
}
template<typename T, typename Y>
inline Vec3<T> operator*(const Vec3<T>& v, Y s)
{
    return Vec3<T>(v.x * s, v.y * s, v.z * s);
}
template<typename T, typename Y>
inline Vec4<T> operator*(Y s, const Vec4<T>& v)
{
    return Vec4<T>(v.x * s, v.y * s, v.z * s, v.w * s);
}
template<typename T, typename Y>
inline Vec4<T> operator*(const Vec4<T>& v, Y s)
{
    return Vec4<T>(v.x * s, v.y * s, v.z * s, v.w * s);
}
template<typename T, typename Y>
inline Vec5<T> operator*(Y s, const Vec5<T>& v)
{
    return Vec5<T>(v.x * s, v.y * s, v.z * s, v.s * s, v.t * s);
}
template<typename T, typename Y>
inline Vec5<T> operator*(const Vec5<T>& v, Y s)
{
    return Vec5<T>(v.x * s, v.y * s, v.z * s, v.s * s, v.t * s);
}
