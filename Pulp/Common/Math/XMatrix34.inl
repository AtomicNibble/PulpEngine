...
{
	m00 = T(m.m00);		m01 = T(m.m01);		m02 = T(m.m02);		// m03 = 0;
	m10 = T(m.m10);		m11 = T(m.m11);		m12 = T(m.m12);		// m13 = 0;
	m20 = T(m.m20);		m21 = T(m.m21);		m22 = T(m.m22);		//m23 = 0;

	m03 = T(0);			m13 = T(0);			m23 = T(0);
...
{
	m00 = T(m.m00);		m01 = T(m.m01);		m02 = T(m.m02);		// m03 = T(t.x);
	m10 = T(m.m10);		m11 = T(m.m11);		m12 = T(m.m12);		// m13 = T(t.y);
	m20 = T(m.m20);		m21 = T(m.m21);		m22 = T(m.m22);		// m23 = T(t.z);

	m03 = T(t.x);		m13 = T(t.y);		m23 = T(t.z);
}
...
{
	m00 = T(m.m00);		m01 = T(m.m01);		m02 = T(m.m02);		//m03 = T(m.m03);
	m10 = T(m.m10);		m11 = T(m.m11);		m12 = T(m.m12);		//m13 = T(m.m13);
	m20 = T(m.m20);		m21 = T(m.m21);		m22 = T(m.m22);		//m23 = T(m.m23);

	m03 = T(m.m03);		m13 = T(m.m13);		m23 = T(m.m23);
}
...
X_INLINE void Matrix34<T>::set(const T* dt, bool srcIsRowMajor)
{
	if (srcIsRowMajor) {
		...
		m[9] = dt[9]; m[10] = dt[10]; m[11] = dt[11];
	}
	else {
	...
	T d7, T d8, T d9, T d10, T d11, bool srcIsRowMajor)
{
	if (srcIsRowMajor)
	{
		...
		m[1] = d4; m[4] = d5; m[7] = d6;
		m[2] = d8; m[5] = d9; m[8] = d10;

		// trans
		m[9] = d3; m[10] = d7; m[11] = d11;
	}
	else
	{
...
X_INLINE Matrix34<T> Matrix34<T>::createTranslation(const Vec3<T> &v)
{
	...
	ret.m00 = 1.0f;	ret.m01 = 0.0f;	ret.m02 = 0.0f;
	ret.m10 = 0.0f;	ret.m11 = 1.0f;	ret.m12 = 0.0f;
	ret.m20 = 0.0f;	ret.m21 = 0.0f;	ret.m22 = 1.0f;
