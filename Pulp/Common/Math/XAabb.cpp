...
void AABB::set(const OBB& obb)
{
    ...
    Vec3f halfSize = Vec3f::abs(o.getColumn(0) * halfVec[0]) + Vec3f::abs(o.getColumn(1) * halfVec[1]) + Vec3f::abs(o.getColumn(2) * halfVec[2]);
...
AABB AABB::createTransformedAABB(const Matrix33f& m33, const AABB& aabb)
{
    ...
    Vec3f halfSize = Vec3f::abs(m33.getColumn(0) * halfVec[0]) + Vec3f::abs(m33.getColumn(1) * halfVec[1]) + Vec3f::abs(m33.getColumn(2) * halfVec[2]);
