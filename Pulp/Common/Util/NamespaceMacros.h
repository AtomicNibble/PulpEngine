...
#define X_NAMESPACE_BEGIN(name)						namespace X_NAMESPACE_NAME { namespace name {
#define X_NAMESPACE_END								} }
#define X_NAMESPACE_DECLARE(name, symbol)			X_NAMESPACE_BEGIN(name) symbol; X_NAMESPACE_END
