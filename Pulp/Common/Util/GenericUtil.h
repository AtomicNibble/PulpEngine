...
template<class T>
X_INLINE constexpr const T& Min(const T& x, const T& y)
{
    return (x < y) ? x : y;
}

template<class T>
X_INLINE constexpr const T& Max(const T& x, const T& y, const T& c)
{
    return Max(Max(x, y), c);
}
template<class T>
X_INLINE constexpr const T& Min(const T& x, const T& y, const T& c)
{
    return Min(Min(x, y), c);
}
