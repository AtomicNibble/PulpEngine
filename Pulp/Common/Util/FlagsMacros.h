...
#define X_DECLARE_FLAGS_IMPL_TO_STRING(value, n)			case value: return X_PP_STRINGIZE(value);
...
#define X_DECLARE_FLAGS_IMPL(...)																											\
	{																																		\
		...
		struct Bits																															\
		{																																	\
			X_PP_EXPAND_ARGS X_PP_PASS_ARGS(X_DECLARE_FLAGS_IMPL_BITS, __VA_ARGS__)														\
		};																																	\
																																			\
		...
		{																																	\
			switch (value)																													\
			{																																\
				X_PP_EXPAND_ARGS X_PP_PASS_ARGS(X_DECLARE_FLAGS_IMPL_TO_STRING, __VA_ARGS__)												\
				default:																													\
					X_NO_SWITCH_DEFAULT;																									\
			}																																\
		}																																	\
...
struct Bits																															\
		{																																	\
		X_PP_EXPAND_ARGS X_PP_PASS_ARGS(X_DECLARE_FLAGS8_IMPL_BITS, __VA_ARGS__)														\
		};																																	\
		\
