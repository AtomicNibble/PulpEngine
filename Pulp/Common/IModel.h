...
#define X_MODEL_MTL_PATCH_DOUBLE_UNDERSCORE 1
...
struct ModelHeader // File header.
{
    ...
    X_INLINE bool isValid(void) const
    {
        ...
        return version == MODEL_VERSION && (numBones + numRootBones) > 0 && numLod > 0 && numLod <= MODEL_MAX_LODS && materialNameDataSize > 0;
    }
};
