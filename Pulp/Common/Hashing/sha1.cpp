...
#define SHABLK0(i) (block_.l[i] = (ROL32(block_.l[i], 24) & 0xFF00FF00) | (ROL32(block_.l[i], 8) & 0x00FF00FF))
#else
#define SHABLK0(i) (buffer.l[i])
#endif

#define SHABLK(i) (block_.l[i & 15] = ROL32(block_.l[(i + 13) & 15] ^ block_.l[(i + 8) & 15] ^ block_.l[(i + 2) & 15] ^ block_.l[i & 15], 1))
