...
namespace traits
{
    ...
    namespace internal
    {
        // Internal struct used by traits::MemberFunction.
    ...
    // \ingroup Traits
    // A traits class for member functions with arbitrary signature.
    // This class template helps with declaring pointers-to-member-functions in a meaningful and descriptive
    ...
    // scripting languages. See traits::Function for an example.
    // \sa Function
    ...
    // Partial template specialization for member functions having no arguments.
    // \sa MemberFunction
    template<class C, typename R>
    ...
    // Partial template specialization for member functions having one argument.
    // \sa MemberFunction
    template<class C, typename R, typename A0>
    ...
    // Partial template specialization for member functions having two arguments.
    // \sa MemberFunction
    template<class C, typename R, typename A0, typename A1>
    ...
    // Partial template specialization for member functions having three arguments.
    // \sa MemberFunction
    template<class C, typename R, typename A0, typename A1, typename A2>
    ...
    // Partial template specialization for member functions having four arguments.
    // \sa MemberFunction
    template<class C, typename R, typename A0, typename A1, typename A2, typename A3>
    ...
    // Partial template specialization for member functions having five arguments.
    // \sa MemberFunction
    template<class C, typename R, typename A0, typename A1, typename A2, typename A3, typename A4>
    ...
    // Partial template specialization for member functions having six arguments.
    // \sa MemberFunction
    template<class C, typename R, typename A0, typename A1, typename A2, typename A3, typename A4, typename A5>
