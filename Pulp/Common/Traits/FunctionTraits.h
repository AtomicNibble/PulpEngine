...
namespace traits
{
    namespace internal
    {
        // Internal struct used by traits::Function.
        template<typename R>
    ...
    // \ingroup Traits
    // A traits class for functions with arbitrary signature.
    // This class template helps with declaring pointers-to-functions in a meaningful and descriptive
    ...
    // Partial template specialization for functions having no arguments.
    // \sa Function
    template<typename R>
    ...
    // Partial template specialization for functions having one argument.
    // \sa Function
    template<typename R, typename A0>
    ...
    // Partial template specialization for functions having two arguments.
    // \sa Function
    template<typename R, typename A0, typename A1>
    ...
    // Partial template specialization for functions having three arguments.
    // \sa Function
    template<typename R, typename A0, typename A1, typename A2>
    ...
    // Partial template specialization for functions having four arguments.
    // \sa Function
    template<typename R, typename A0, typename A1, typename A2, typename A3>
    ...
    // Partial template specialization for functions having five arguments.
    // \sa Function
    template<typename R, typename A0, typename A1, typename A2, typename A3, typename A4>
    ...
    // Partial template specialization for functions having six arguments.
    // \sa Function
    template<typename R, typename A0, typename A1, typename A2, typename A3, typename A4, typename A5>
