...
public:
	...
	AlignedArray(MemoryArenaBase* arena);
	AlignedArray(MemoryArenaBase* arena, size_type size);
	AlignedArray(MemoryArenaBase* arena, size_type size, const T& initialValue);
	AlignedArray(MemoryArenaBase* arena, std::initializer_list<T> iList);
	AlignedArray(const AlignedArray& oth);
	AlignedArray(AlignedArray&& oth);
	~AlignedArray(void);

	void setArena(MemoryArenaBase* arena);
	void setArena(MemoryArenaBase* arena, size_type capacity);

	AlignedArray<T>& operator=(std::initializer_list<T> iList);
	AlignedArray<T>& operator=(const AlignedArray<T>& oth);
	AlignedArray<T>& operator=(AlignedArray<T>&& oth);
	...
	// set new granularity
	void setBaseAlignment(size_type newAlign);
	// get the current granularity
	size_type baseAlignment(void) const;
	...
	// add the list
	size_type append(const AlignedArray<T>& oth);
