...
namespace debugging
{
    // Writes a minidump to a file.
    // A dump file allows programmers to save program information for debugging at a later time. They are
    ...
    // Code generation is enabled/disabled via the preprocessor option X_ENABLE_MINI_DUMP. Disabling
