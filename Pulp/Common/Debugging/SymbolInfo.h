...
// \class SymbolInfo
// Stores debugging symbol information.
// This class stores information such as function name, file name, and line number for debugging symbols,
// mostly used internally by the symbol resolution facility.
// \sa symbolResolution
class SymbolInfo
{
public:
    // Constructs a symbol info instance, copying the given arguments.
    // Ownership of the provided arguments stays at the calling site.
