...
X_INLINE XFixedJoint::XFixedJoint(physx::PxFixedJoint* pJoint) : XJoint(pJoint)
{
...
X_INLINE XDistanceJoint::XDistanceJoint(physx::PxDistanceJoint* pJoint) : XJoint(pJoint)
{
...
X_INLINE XSphericalJoint::XSphericalJoint(physx::PxSphericalJoint* pJoint) : XJoint(pJoint)
{
...
X_INLINE XRevoluteJoint::XRevoluteJoint(physx::PxRevoluteJoint* pJoint) : XJoint(pJoint)
{
...
X_INLINE XPrismaticJoint::XPrismaticJoint(physx::PxPrismaticJoint* pJoint) : XJoint(pJoint)
{
