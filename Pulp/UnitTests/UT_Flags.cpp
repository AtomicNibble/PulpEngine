...
X_DECLARE_FLAGS(TestF) (VAL_1, VAL_2, VAL_3, VAL_4, VAL_5, VAL_6, VAL_7, VAL_8,
						VAL_9, VAL_10);
...
TEST(FlagTest, Genral) {
	...
	// set them all o.o
	flag |= Flags<TestF>(
		TestF::VAL_3 | TestF::VAL_4 | TestF::VAL_5 | TestF::VAL_6 |
		TestF::VAL_7 | TestF::VAL_8 | TestF::VAL_9 | TestF::VAL_10
		);
