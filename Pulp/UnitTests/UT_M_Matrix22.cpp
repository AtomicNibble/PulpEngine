...
TYPED_TEST(Mat22, Contruction)
{
    ...
    // const Vec2<T> operator*( const Vec2<T> &rhs ) const;
    {
        ...
        EXPECT_LT(fabs(diff.x), Matrix22<T>::EPSILON);
        EXPECT_LT(fabs(diff.y), Matrix22<T>::EPSILON);
    }
    ...
    {
        MatT c0(1, 2, 3, 4);
        EXPECT_LT(fabs(1 - c0.at(0, 0)), Matrix22<T>::EPSILON);
        EXPECT_LT(fabs(2 - c0.at(1, 0)), Matrix22<T>::EPSILON);
        EXPECT_LT(fabs(3 - c0.at(0, 1)), Matrix22<T>::EPSILON);
        EXPECT_LT(fabs(4 - c0.at(1, 1)), Matrix22<T>::EPSILON);
    }
    ...
    // T determinant() const;
    {
        ...
        EXPECT_LT(fabs(det - (T)-2.0), Matrix22<T>::EPSILON);
    }
    // T trace() const;
    {
        MatT m0(1, 2, 3, 4);
        T trace = m0.trace();
        EXPECT_LT(fabs(trace - (T)5.0), Matrix22<T>::EPSILON);
    }
    ...
    // void invert (T epsilon = Matrix22<T>::EPSILON );
    {
    ...
    // Matrix22<T> inverted( T epsilon = Matrix22<T>::EPSILON ) const;
    {
        MatT c0(-2, 1, (T)1.5, (T)-0.5);
        MatT m0(1, 2, 3, 4);
    ...
    // Vec2<T> preMultiply( const Vec2<T> &v ) const;
    {
        ...
        EXPECT_LE(fabs(diff.x), Matrix22<T>::EPSILON);
        EXPECT_LE(fabs(diff.y), Matrix22<T>::EPSILON);
    }
