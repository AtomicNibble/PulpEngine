...
public:
    ...
    bool InitializeLoadedEngineModule(const char* pDllName, const char* pModuleClassName) X_FINAL;
    bool InitializeLoadedConverterModule(const char* pDllName, const char* pModuleClassName,
