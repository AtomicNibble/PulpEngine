...
X_INLINE int32_t GameVars::drawClientInterpolationDebug(void) const
{
    return drawClientInterpolationDebug_;
}

X_INLINE int32_t GameVars::clientInterpolation(void) const
{
    return clientInterpolation_;
}
