...
void PlayerVars::registerVars(void)
{
	...
	ADD_CVAR_REF("ply_thirdperson_range", thirdPersonRange_, thirdPersonRange_, 0, 256, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"The distance of the 3rd person camera from player");
	ADD_CVAR_REF("ply_thirdperson_angle", thirdPersonAngle_, thirdPersonAngle_, 0, 360, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"Direction of 3rd person camera in degrees. (0: behind player)");

	ADD_CVAR_REF("ply_jump_height", jumpHeight_, jumpHeight_, 0, 256, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"MAx height player can jump");
	ADD_CVAR_REF("ply_crouch_view_height", crouchViewHeight_, crouchViewHeight_, 0, 256, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
	...
	ADD_CVAR_REF("ply_bob_up", bobUp_, bobUp_, 0, 1.f, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"");
	ADD_CVAR_REF("ply_bob_pitch", bobPitch_, bobPitch_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"");
	ADD_CVAR_REF("ply_bob_roll", bobRoll_, bobRoll_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"");
	ADD_CVAR_REF("ply_bob_run_pitch", bobRunPitch_, bobRunPitch_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"");
	ADD_CVAR_REF("ply_bob_run_roll", bobRunRoll_, bobRunRoll_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"");


	ADD_CVAR_REF("ply_walk_speed", walkSpeed_, walkSpeed_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"Move speed when walking");
	ADD_CVAR_REF("ply_run_speed", runSpeed_, runSpeed_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
		"Move speed when running");
	ADD_CVAR_REF("ply_crouch_speed", crouchSpeed_, crouchSpeed_, 0, 512, core::VarFlag::SYSTEM | core::VarFlag::CHEAT,
