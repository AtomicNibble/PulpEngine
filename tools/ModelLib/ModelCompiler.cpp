...
const ModelCompiler::CompileFlags ModelCompiler::DEFAULT_FLAGS = ModelCompiler::CompileFlags(ModelCompiler::CompileFlag::WHITE_VERT_COL | ModelCompiler::CompileFlag::MERGE_MESH);
...
bool ModelCompiler::saveModel(core::XFile* pFile)
{
    ...
    header.dataSize = (header.tagNameDataSize + header.materialNameDataSize + header.boneDataSize + header.physDataSize + (header.hitboxDataBlocks * 64) + header.meshDataSize);
