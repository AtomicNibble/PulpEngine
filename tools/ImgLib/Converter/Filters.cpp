...
namespace Converter
{
	...
	void Kernel2::initLaplacian(void)
	{
		...
		data_[0] = +0; data_[1] = -1; data_[2] = +0;
		data_[3] = -1; data_[4] = +4; data_[5] = -1;
		data_[6] = +0; data_[7] = -1; data_[8] = +0;
	...
	void Kernel2::initEdgeDetection(void)
	{
		...
		data_[3] = -1; data_[4] = 0; data_[5] = 1;
		data_[6] = 0; data_[7] = 0; data_[8] = 0;
	}
	...
	void Kernel2::initSobel(void)
	{
		if (windowSize_ == 3)
		{
			data_[0] = -1; data_[1] = 0; data_[2] = 1;
			data_[3] = -2; data_[4] = 0; data_[5] = 2;
			data_[6] = -1; data_[7] = 0; data_[8] = 1;
		}
