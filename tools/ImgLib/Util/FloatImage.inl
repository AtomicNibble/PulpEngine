...
namespace Converter
{
    ...
    {
        X_ASSERT(component < componentCount_, "Component index out of range")
    ...
    {
        X_ASSERT(z < depth_, "Depth index out of range")
        (z, depth_);
    ...
    {
        X_ASSERT(y < height_, "Height index out of range")
        (y, height_);
    ...
    {
        X_ASSERT(x < width_, "Width index out of range")
        (x, width_);
        X_ASSERT(y < height_, "Height index out of range")
        (y, height_);
        X_ASSERT(z < depth_, "Depth index out of range")
        ...
        X_ASSERT(idx < pixelCount_, "Pixel index out of range")
        (idx, pixelCount_);
        return idx;
    }
