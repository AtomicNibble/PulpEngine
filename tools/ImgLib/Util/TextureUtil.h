...
namespace Util
{
    ...
    IMGLIB_EXPORT bool isBGR(Texturefmt::Enum fmt);
    ...
    IMGLIB_EXPORT Texturefmt::Enum TexFmtFromStr(core::string_view str);
    IMGLIB_EXPORT ImgFileFormat::Enum ImgFileFmtFromStr(const char* pStr);
    IMGLIB_EXPORT ImgFileFormat::Enum ImgFileFmtFromStr(core::string_view str);
